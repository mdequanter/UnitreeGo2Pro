...
/* This code was tested on a ESP32 WEMOS Lite v1 and ESPDUINO 32 
SBUS connected to pin 16 
More info on :  https://wiki.theroboverse.com/en/sbus and https://github.com/mechzrobotics/Unitree_GO2_SBUS.git*/

ControllerPtr myControllers[BP32_MAX_GAMEPADS];

/* SBUS object, reading SBUS */
bfs::SbusRx sbus_rx(&Serial1, 0, 16, true);
/* SBUS object, writing SBUS */
bfs::SbusTx sbus_tx(&Serial1, 0, 16, true);
/* SBUS data */
bfs::SbusData data;
...
void processGamepad(ControllerPtr ctl) {
    ...
    if (X == 1) {
      if(X_Flag == 0){
        Serial.println("Obstacle Avoidance Toggle");
        if(OBSTACLE_Flag == 0){
